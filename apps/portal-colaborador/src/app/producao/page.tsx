...
function ProducaoContent() {
  ...
  return (
    <PortalLayout
      ...
      header={<Header title="Produção" userName={user?.name} onLogout={logout} />}
    >
      {ordens.length === 0 ? (
        <p className="text-center py-12 text-gray-500">Nenhuma ordem de produção.</p>
      ) : (
...
const Authenticated = withAuth(ProducaoContent);
