...
export function MaterialCategoryTable({
  categories, loading, onToggleActive, onRemove,
}: MaterialCategoryTableProps) {
  ...
  if (!categories.length) {
    return (
      <EmptyState
        ...
        description="Nenhuma categoria de material cadastrada."
      />
    );
  }
        ...
        <TableBody>
          {categories.map((cat) => (
            <TableRow key={cat.id}>
              ...
              <TableCell>
                <MaterialCategoryBadge active={cat.active} />
              </TableCell>
              <TableCell>
