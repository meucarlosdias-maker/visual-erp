...
export type MaterialCategorySchemaType = z.infer<typeof materialCategorySchema>;

export const materialCategoryFormSchema = materialCategorySchema.omit({
  id: true, companyId: true,
  createdAt: true, updatedAt: true, deletedAt: true,
  createdBy: true, updatedBy: true, deletedBy: true,
});

export type MaterialCategoryFormType = z.infer<typeof materialCategoryFormSchema>;
